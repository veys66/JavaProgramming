...
public class StringMethods {
    public static void main(String[] args) {
       ...
       boolean r= str.isEmpty();
        ...
        boolean z= a.toLowerCase().startsWith("wooden");// in order to ignore the case sensitivity we first create the lower case/upper case version of string and then
